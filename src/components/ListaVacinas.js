    ...
    const renderItem = ({ item }) =>
        !item.vacinaTomada ? (
            item.pendente ? (
                <View style={styles.vacinaPendenteContainer}>
                    ...
                    <Text style={styles.doses}>
                        Dose: {item.doseAtual}/{item.doseTotal}
                    </Text>
                    <Text style={styles.descricaoVacina}>
                        Descrição: {item.descricao}{" "}
                    </Text>
                    <Text style={styles.dataVacina}>
                        Data: {moment(item.dataDose).format("DD/MM/YYYY")}
                    </Text>
                    <Text style={styles.dataVacinaPendente}>
                        Atenção: essa vacina está atrasada!
                    </Text>
                    <TouchableOpacity
                    ...
                    >
                        <Text style={styles.textPendenteButton}>
                ...
                <View style={styles.vacinaContainer}>
                    ...
                    <Text style={styles.dataVacina}>
                        Próxima dose até:{" "}
                        {moment(item.dataDose).format("DD/MM/YYYY")}
                    </Text>
                    <TouchableOpacity
                        style={styles.button}
                        onPress={() =>
            ...
            <View style={styles.vacinaTomadaContainer}>
                ...
                <Text style={styles.dosesTomadas}>
                    Dose: {item.doseAtual}/{item.doseTotal}
                </Text>
                <Text style={styles.descricaoVacinaTomada}>
                    Descrição: {item.descricao}{" "}
                </Text>
                <Text style={styles.dataVacinaTomada}>
                    Todas as doses foram tomadas!
                </Text>
            </View>
        );
            ...
            <View style={styles.container}>
                <View style={styles.header}>
                    ...
                    <Text style={styles.label}>
                        Agenda de {getPrimeiroNome(nomePessoa)} 📅
                    </Text>
                </View>
